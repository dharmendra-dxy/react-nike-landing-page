    ...
    >
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-4 lg:max-w-lg info-text">
          Ensuring premimum comfort an style, our meticulously created footware is designed to elevate your experiences, providing you with unmatched quality, inpvation, and a touch of elegance.
        </p>
